...
- [Available Scripts](#available-scripts)
  ...
  - [npm run start-dev-server](#npm-run-start-dev-server)
...
Responsible to connect to the database.

**Note: Provide `ATLAS_URI` environment variable in the `.env` file under root directiry.**
